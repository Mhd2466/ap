...
public class Main_EX2_PM_3_1_D extends JFrame implements KeyListener {
    ...
    private static final int MAX_SCORE = 10; //max score
    private static final long MAX_GAME_TIME_MS = 30000; // max time
    private long startTime; // time of the game
    ...
    private void logic() {
        ...
        if (elapsedTime >= MAX_GAME_TIME_MS) {
